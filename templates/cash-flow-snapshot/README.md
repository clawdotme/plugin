...
Version 3.0.0. Authored content lives in `../collection.json`; regenerate with `python3 templates/collection.py`. Shared styling is compiled from Tailwind. The cashflow edition uses native section navigation and disclosures where useful. Data is illustrative, with no live service connection.
